...
class TriviaTestCase(unittest.TestCase):
    ...
    def test_requesting_beyond_valid_page_404(self):
        res = self.client().get('/questions?page=711')
        data = json.loads(res.data)
    ...
    def test_delete_an_invalid_question_404(self):
        res = self.client().delete('/questions/711')
        data = json.loads(res.data)
    ...
    def test_for_failed_play_400(self):
    ...
    def test_failed_create_question_400(self):
    ...
    def test_failed_search_question_400(self):
    ...
    def test_failed_retrieve_questions_by_category(self):
